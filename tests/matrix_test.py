...
from claude_gemini_mcp.config import GeminiConfig, get_config, reload_config
...
class TestConfigurationMatrix:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                {"models": {"assignments": {"quick_query": "pro"}}},
                "quick_query",
                "gemini-2.5-pro",
            ),
            ...
            (
                {
                    "models": {
                        ...
                        "assignments": {"analyze_code": "flash"},
                    }
                },
                "analyze_code",
    ...
    def test_configuration_with_config_file(
        self, config_data: Dict[str, Any], tool_name: str, expected_model: str
    ) -> None:
        """
        ...
        try:
            with patch(
                "claude_gemini_mcp.config.GeminiConfig._find_config_file",
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                {"CLI_TIMEOUT": "120", "API_TIMEOUT": "45"},
                {"cli_timeout": 120, "api_timeout": 45},
            ),
            # Test case 3: Size limit environment variables
            (
                {"MAX_FILE_SIZE": "102400", "MAX_LINES": "1000"},
                {"max_file_size": 102400, "max_lines": 1000},
            ),
        ],
    )
    def test_environment_variable_overrides(
        self, env_vars: Dict[str, str], expected_values: Dict[str, Any]
    ) -> None:
        """
    ...
    def test_explicit_parameter_precedence(
        self, explicit_override: Optional[str], expected_result: str
    ) -> None:
        """
