...
from gemini_mcp_server import execute_gemini_api, execute_gemini_cli_streaming, GOOGLE_API_KEY
...
class TestGeminiAPIIntegration:
    ...
    async def test_api_success_flow(self):
        ...
        with patch.dict('sys.modules', {'google.generativeai': mock_genai}):
            with patch('gemini_mcp_server.GOOGLE_API_KEY', 'valid_api_key_1234567890'):
                ...
                mock_genai.configure.assert_called_once_with(api_key='valid_api_key_1234567890')
    ...
    async def test_api_key_redaction_in_errors(self):
        ...
        error_with_key = Exception("Error with key AIzaSyBHJ5X2K9L8M3N4O5P6Q7R8S9T0U1V2W3X4Y5Z in message")
        ...
        with patch.dict('sys.modules', {'google.generativeai': mock_genai}):
            with patch('gemini_mcp_server.GOOGLE_API_KEY', 'valid_api_key_1234567890'):
                ...
                assert result["success"] is False
                assert "AIzaSyBHJ5X2K9L8M3N4O5P6Q7R8S9T0U1V2W3X4Y5Z" not in result["error"]
        ...
        with patch('asyncio.create_subprocess_exec', return_value=mock_process):
            with patch('gemini_mcp_server.GOOGLE_API_KEY', 'valid_key'):
                ...
                with patch('gemini_mcp_server.execute_gemini_api') as mock_api:
                    ...
                    result = await execute_gemini_cli_streaming("Test prompt", "gemini_quick_query")
    ...
    async def test_cli_command_construction(self):
        ...
        with patch('asyncio.create_subprocess_exec', return_value=mock_process) as mock_exec:
            with patch('gemini_mcp_server.GOOGLE_API_KEY', None):  # Force CLI usage
                ...
                expected_args = ["gemini", "-m", "gemini-2.5-flash", "-p", "Test prompt"]
